...
parser.add_argument("--restore_path", type=str, default="./checkpoint/model_5.ckpt", help="The path of the weights to restore.")
...
with tf.Session() as sess:
    ...
    while True:
        ...
        if args.use_gpu:
            ...
            pred_boxes_, pred_scores_ = sess.run([pred_boxes, pred_scores], feed_dict={input_data: img})
            boxes_, scores_, labels_ = cpu_nms(pred_boxes_, pred_scores_, args.num_class, max_boxes=200, score_thresh=0.3, iou_thresh=0.45)
