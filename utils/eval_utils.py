...
from utils.data_utils import parse_line_1
...
def evaluate_on_cpu(y_pred, y_true, num_classes, calc_now=True, max_boxes=50, score_thresh=0.3, iou_thresh=0.45):
    '''
...
def parse_gt_rec(gt_filename, target_img_size, letterbox_resize=True):
    ...
    if not gt_dict:
        ...
        with open(gt_filename, 'r') as f:
            for line in f:
                img_id, pic_path, boxes, labels, ori_width, ori_height = parse_line_1(line)
