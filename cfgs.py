...
### Some paths
train_path = '../dataset/face_mask/train' #'./data/raccoon_dataset/raccoon_train.txt'  # The path of the training txt file.
val_path = '../dataset/face_mask/val' #'./data/raccoon_dataset/raccoon_test.txt'  # The path of the validation txt file.
restore_path = './checkpoint/model_15.ckpt'#'./data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
...
anchor_path = './data/face_mask_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/face_mask.names'  # The path of the class names.
...
total_epoches = 10
train_evaluation_step = 20  # Evaluate on the training batch after some steps.
...
lr_decay_factor = 0.9  # The learning rate decay factor. Used when chosen `exponential` lr_type.
lr_lower_bound = 1e-6  # The minimum learning rate.
# only used in piecewise lr type
pw_boundaries = [20, 50]  # epoch based boundaries
...
restore_include = None #['yolov3/darknet53_body']
restore_exclude = None #['yolov3/yolov3_head/Conv_14', 'yolov3/yolov3_head/Conv_6', 'yolov3/yolov3_head/Conv_22']
...
nms_topk = 200  # keep at most nms_topk outputs after nms
# mAP eval
